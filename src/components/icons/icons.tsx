...
export const PolygonIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 2l9 4.9V17L12 22l-9-5.1V6.9L12 2z"></path>
        <path d="M12 22V12"></path>
        <path d="M21 6.9l-9 4.9"></path>
        <path d="M3 6.9l9 4.9"></path>
    </svg>
);
...
export const HandIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M18 11a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2h-2.3a2 2 0 0 1-1.7-.7L8 11" />
    </svg>
);
...
export const BrushIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M9.06 18.94L2.06 12a2 2 0 0 1 0-2.82l6-6a2 2 0 0 1 2.82 0l8.94 8.94a2 2 0 0 1 0 2.82l-6 6a2 2 0 0 1-2.82 0z" />
        <path d="M7 13l-4.5 4.5" />
    </svg>
);

export const BubbleToolIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const EditPoseIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const RedoAltIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const LightbulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a7.5 7.5 0 0 1-7.5 0c-1.421 0-2.798-.42-4.002-1.125A18.37 18.37 0 0 1 4.5 1.5a18.37 18.37 0 0 1 15 0c1.01.343 1.93.786 2.755 1.325a7.5 7.5 0 0 1-7.5 0c-1.421 0-2.798-.42-4.002-1.125" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.008a.75.75 0 0 1-.75-.75v-.008Z" />
    </svg>
);

export const WandIcon = (props: React.SVGProps<SVGSVGElement>) => (
     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-2.22-1.313l-1.313-2.22a3 3 0 0 0-1.313-2.22l-2.22-1.313a3 3 0 0 0 0-5.274l2.22-1.313a3 3 0 0 0 1.313-2.22l1.313-2.22a3 3 0 0 0 5.274 0l1.313 2.22a3 3 0 0 0 2.22 1.313l2.22 1.313a3 3 0 0 0 0 5.274l-2.22 1.313a3 3 0 0 0-2.22 1.313l-1.313 2.22a3 3 0 0 0-5.274 0Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="m9.53 16.122 6.6-6.6" />
    </svg>
);
...
export const EyeOffIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.524M4.228 4.228 19.772 19.772" />
    </svg>
);

export const ReturnIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="m15.75 15.75-2.489-2.489m0 0L10.5 15.75M13.261 13.261L10.5 10.5m2.761 2.761L15.75 10.5M15.75 15.75l-2.489-2.489" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75H5.25A2.25 2.25 0 0 1 3 10.5V6.75A2.25 2.25 0 0 1 5.25 4.5h7.5A2.25 2.25 0 0 1 15 6.75v1.5" />
    </svg>
);
...
export const GlobeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 0 0-9-9M3 12a9 9 0 0 1 9 9" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3a9 9 0 0 0 0 18" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 0 1 0-18" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.5 9h19" />
...
export const FilmIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 3.5v.75m0 2.25v.75m0 2.25v.75m0 2.25v.75m0 2.25v.75m0 2.25v.75m12-16.5v.75m0 2.25v.75m0 2.25v.75m0 2.25v.75m0 2.25v.75m0 2.25v.75M12 7.875v8.25" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 7.875v8.25" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 7.875v8.25" />
    </svg>
);
...
export const KeyIcon = (props: React.SVGProps<SVGSVGElement>) => (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
            ...
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 21a8.5 8.5 0 0114-6l4 4v2h-2v-2l-4-4" />
        </svg>
);
